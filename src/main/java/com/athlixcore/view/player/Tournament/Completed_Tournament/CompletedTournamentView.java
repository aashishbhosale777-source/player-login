...
public class CompletedTournamentView {
    ...
    private VBox createCard(String imageSource, String dateRange, String title, String location, String winnerTeam, String accentColor) {
        // Set padding to 0 so the image can stretch edge-to-edge
        ...
        if (imageSource != null && !imageSource.isEmpty()) {
            try {
                if (imageSource.startsWith("http")) {
                    ...
                    // Remove leading slash for direct file path access
        ...
        // Bind width to span edge-to-edge
        imageView.fitWidthProperty().bind(card.widthProperty().subtract(2)); // Subtract borders
        imageView.setFitHeight(140);
        imageView.setPreserveRatio(false);

        // Clip only the top corners to match the card's rounded borders
        ...
        // Add text and button into the padded content box
