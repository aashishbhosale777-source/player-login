...
// //         // Listen for the click and run the UI switch
// //         viewMoreBtn.setOnAction(e -> {
// //             if (onViewMoreAction != null) {
// //                 onViewMoreAction.run();
// //             }
...
// //         // --- 1. NEW STADIUM IMAGE BANNER ---
// //         ImageView bannerImg = loadRobustImage("/assests/images/currentTournament.png");
// //         bannerImg.setFitHeight(180);
// //         bannerImg.setPreserveRatio(false);

// //         StackPane imagePane = new StackPane(bannerImg);
...
// //         // --- 2. TOURNAMENT TITLE (Placed below image) ---
// //         Label bannerTitle = new Label(title);
// //         bannerTitle.setStyle("-fx-font-size: 22px; -fx-font-weight: bold; -fx-text-fill: #0f172a;");
...
// //         detailsBox.getChildren().addAll(l, p);
...
// //         // Assemble the card
// //         card.getChildren().addAll(imagePane, bannerTitle, detailsBox, currentTourneyBtn);
...
//         // --- 1. NEW STADIUM IMAGE BANNER WITH OVERLAID TEXT ---
//         ImageView bannerImg = loadRobustImage("/assests/images/currentTournament.png");
//         bannerImg.setFitHeight(180);
//         bannerImg.setPreserveRatio(false);
...
//         // Assemble the card (Notice bannerTitle is removed here since it's now inside the imagePane)
...
public class CurrentTournament {
    ...
    public Node getView() {
        ...
        // --- ADDED UNIQUE IMAGE PATHS FOR EACH CARD ---
        tournamentsList.getChildren().addAll(
    ...
    // --- UPDATED: Accepts imagePath as a parameter ---
    private VBox createTournamentCard(String title, String loc, String prize, String accentColor, String imagePath) {
        ...
        // --- 1. NEW STADIUM IMAGE BANNER WITH OVERLAID TEXT ---
        ImageView bannerImg = loadRobustImage(imagePath); // Uses the passed dynamic image path
        bannerImg.setFitHeight(180);
        bannerImg.setPreserveRatio(false);
