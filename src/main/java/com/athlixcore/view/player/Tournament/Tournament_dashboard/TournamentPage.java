// package com.athlixcore.view.player.Tournament.Tournament_dashboard;

// import com.athlixcore.view.player.Tournament.Completed_Tournament.CompletedTournament;
// import com.athlixcore.view.player.Tournament.Completed_Tournament.CompletedTournamentView;
// import com.athlixcore.view.player.Tournament.Completed_Tournament.CompletedTournamentonviewTournament;
// import com.athlixcore.view.player.Tournament.Current_Tournament.CurrentTournament;
// import com.athlixcore.view.player.Tournament.Current_Tournament.CurrentTournamentLiveMatch;
...
//         String imgPath1 = "file:src/main/resources/assests/images/Upcoming_Tournament1.png"; 
//         String imgPath2 = "file:src/main/resources/assests/images/Upcoming_Tournament2.png";
//         String imgPath3 = "file:src/main/resources/assests/images/Upcoming_Tournament3.png";
...
public class TournamentPage {
    ...
    private VBox createTournamentCard(String imageSource, String title, String org, String loc, String fee, String prize, String btnText, String accentColor) {
        VBox card = new VBox(0); // 0 padding between image and text block
        card.setStyle("-fx-background-color: white; -fx-background-radius: 12; -fx-border-color: " + accentColor + " #e2e8f0 #e2e8f0 #e2e8f0; -fx-border-width: 4 1 1 1; -fx-border-radius: 12;");
        HBox.setHgrow(card, Priority.ALWAYS);
        ...
        // Content box for text and buttons below the image
        ...
        buttonBox.getChildren().addAll(viewDetailsBtn, primaryBtn);
        contentBox.getChildren().addAll(t, o, l, details, buttonBox);
