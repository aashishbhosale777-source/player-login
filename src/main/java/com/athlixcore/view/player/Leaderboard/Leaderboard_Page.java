...
// public class Leaderboard_Page extends StackPane { // Changed to StackPane for background layering!
...
//     // This holds whatever page is currently active (Leaderboard, Grid, or Profile)
...
//                 bgImage.setPreserveRatio(false); // Stretches to fill the entire container
//                 bgImage.fitWidthProperty().bind(this.widthProperty());
//                 bgImage.fitHeightProperty().bind(this.heightProperty());
//             } else {
//                 // If it fails, this will print exactly where Java is looking in your terminal!
...
//         // --- LAYER 2: DARK OVERLAY (Ensures text is readable) ---
...
//         mainTitle.setStyle("-fx-font-size: 28px; -fx-font-weight: bold; -fx-text-fill: white;"); // Changed to White
//         Label subTitle = new Label("Top performers across all formats and categories");
//         subTitle.setStyle("-fx-font-size: 14px; -fx-text-fill: #cbd5e1;"); // Light silver
...
//         } else {
//             // Semi-transparent tabs for dark background
...
//         title.setStyle("-fx-font-size: 18px; -fx-font-weight: bold; -fx-text-fill: white;"); // Changed to White
...
//         // Styled solid background for dark stadium backdrop
...
//         mainTitle.setStyle("-fx-font-size: 24px; -fx-font-weight: bold; -fx-text-fill: white;"); // Changed to white
...
//                 else {
//                     java.io.File file = new java.io.File("assests\\images\\ranking image crkt.avif" + imgPath);
